...
V8.1 Face Overlay Engine

NEW:
- Auto-anchor correction using facial landmarks
- Fixes vertical misalignment automatically
- Keeps V8 per-page anchor system

Pipeline:
JSON anchor (coarse) + Auto correction (fine) = stable output
"""
